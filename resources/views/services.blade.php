   ...
   <div class="container">
		<div class="row">				
			<div class="col-md-4">
				<div class="wow bounceIn" data-wow-offset="0" data-wow-delay="0.4s">
					<div class="align-center">
						...
						<p>
						Eligible for Kenyan citizens who have never been issued with an Identity Card.
						</p>
						<div class="ficon">
							<a href="{{route('newidreq')}}" class="btn btn-default" role="button">Apply now</a>
						</div>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="wow bounceIn" data-wow-offset="0" data-wow-delay="0.4s">
					<div class="align-center">
						<h4>Replace ID Card</h4>				
						<div class="icon">
							<i class="fa fa-check-square-o fa-2x"></i>
						</div>
						<p>
						Eligible for Kenyan citizens seeking to replace their lost, torn, and worn out or mutilated ID cards.
						</p>
						<div class="ficon">
							<a href="{{route('replaceidreq')}}" class="btn btn-default" role="button">Apply now</a>
						</div>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="wow bounceIn" data-wow-offset="0" data-wow-delay="0.4s">
					<div class="align-center">
						<h4>Change ID Particulars</h4>					
						<div class="icon">
							<i class="fa fa-check-square-o fa-2x"></i>
						</div>
						<p>
						 Eligible for Kenyan citizen ID card holder who want to change name upon marriage, change of location.
						</p>
						<div class="ficon">
							<a href="{{route('changepartireq')}}" class="btn btn-default" role="button">Apply now</a>
						</div>
					</div>
				</div>
			</div>				
