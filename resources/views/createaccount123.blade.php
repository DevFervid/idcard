...
<html lang="en">
  ...
  <body>
	...
	<div class="jumbotron">
	 ...
	 <section class="maingallery" id="home">
    <div class="overlay">
      <div class="container">
          <div class="row">
                        ...
                        <form>
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" required="required" placeholder="Birth Certificate No / ID No">
                                </div>
                            </div>
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" required="required" placeholder="Date of Birth">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" required="required" placeholder="Mobile Number">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12">
                             ...
                             <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" required="required" placeholder="Confirm Password">
                                </div>
                            </div>
