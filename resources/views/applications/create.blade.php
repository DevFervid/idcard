                        ...
                        <form action="{{ route('applications.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                 ...
                                 <input type="text" class="form-control" name="lname" value="{{old('lname')}}" placeholder="">
                                </div>
                            </div><br>
                             <div class="form-group">
                                <label>Date of Birth</label>
                                <input class="form-control"  type="text" id="datepicker" name="date" value="{{old('date')}}"> 
                             </div>  
                             <br>
                            <div class="form-group">
                            ...
                            <br><br>
                             <div class="row">
                                <div class="col">
                                 ...
                                 <input type="text" class="form-control" name="fathers_name" value="{{old('fathers_name')}}" placeholder="">
                                </div>
                                <div class="col">
                                 <label>Mother's Name</label>
                                 <input type="text" class="form-control" name="mothers_name" value="{{old('mothers_name')}}" placeholder="">
                                </div>
                            </div><br>
                            <div class="form-group">
                                <select class="custom-select">
                            ...
                            <br><br>
                             <div class="row">
                                <div class="col">
                                 ...
                                 <input type="text" class="form-control" name="husband_name" value="{{old('husband_name')}}" placeholder="">
                                </div>
                                <div class="col">
                                 <label>Husband's ID/NO</label>
                                 <input type="text" class="form-control" name="husband_idno" value="{{old('husband_idno')}}" placeholder="">
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="col">
                                ...
                                <div class="col">
                                 <label>Clan</label>
                                 <input type="text" class="form-control" name="clan" value="{{old('clan')}}" placeholder="">
                                </div>
                                <div class="col">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                 ...
                                 <input type="text" class="form-control" name="home_address" value="{{old('home_address')}}" placeholder="">
                                </div>
                             ...
                             <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="occupation" value="{{old('occupation')}}" placeholder="">
                             </div> <br> 
                            <div class="form-group">
                                <label>Upload supporting documents</label>
                                <input type="file" class="form-control-file" name="filename" value="{{old('filename')}}">
                            </div>
                            <br><br>
