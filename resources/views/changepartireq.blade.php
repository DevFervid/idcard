...
<html lang="en">
  ...
  <body>
				...
				<div class="container">					
					<div class="navbar-header">
						...
						<div class="navbar-brand">
							<h1><img src="img/slider/logo9.png" alt=""/></h1>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-8">
					<div class="page-header">
						...
						<p>
							 <ul>
                     			<li>Persons who qualify for this service. A person holding an ID card can change from one civil status to another e.g. Change of name upon marriage, change of location, additional name etc.  </li>
  								<li>A combination of any of the following documents depending on the type of change:-</li>
  								<p>Marriage Certificate.</p>
  								<p>School leaving Certificates.</p>
  								<p>Confirmation letters from administrative office.</p>
  								<p>Birth Certificate.</p>
  								<p>Copy of parents ID card.</p>
  								<p>Parental consent to marriage.</p>
  								<p>Divorce Certificate.</p>
  								<p>Sworn affidavits.</p>
  								<li> Ksh 1000/= for change of ID particulars.</li>
						...
						<p>
								<ol>
                         		<li>Create an account or login if you already have an account. </li>
  								<li>Follow the instructions to fill the application form provided.</li>
	...
	<div class="jumbotron">
		...
		<p><a class="btn btn-primary btn-lg" href="createaccount.html" role="button">Get it now</a></p>
	</div>
