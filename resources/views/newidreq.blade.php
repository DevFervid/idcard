			...
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-8">
					<div class="page-header">
						...
						<p>
							 <ul>
                     			<li>Must be a Kenyan citizens who have never been issued with an Identity Card. </li>
  								<li>Must be 18 years and above.</li>
  								<li>Copy of your original birth certificate.</li>
  								<li>Copy of your school leaving certificate.</li>
  								<li>Your birth clinic card.</li>
  								<li>Parents ID card copies for Kenyans by birth. </li>
  								<li>Letter of administrative officer-Chief/Assistant Chief.</li>
  								<li>2 passport size photos.</li>

  								<p> NB: No fee charged for initial registration</p>
							</ul>
						</p>
